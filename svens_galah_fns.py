...
data_directory = 'svens_data/buder/svn-repos/trunk/GALAH/'
...
def read_spectra(sobject_id, iraf_dr = 'dr5.2', SPECTRA = 'SPECTRA', ccds=[1,2,3,4]):
    """
    ...
    for each_ccd in ccds:
        fits = pyfits.open(data_directory+SPECTRA+'/'+iraf_dr+'/'+str(sobject_id)[0:6]+'/standard/'+com+'/'+str(sobject_id)+str(each_ccd)+'.fits')
